...
public class GameManager extends GameCore {
    ...
    */
    ...
    public boolean shooting = false;//set to false
    ...
    private void checkInput(long elapsedTime) {
        ...
        if (player.isAlive()) {
          ...
          //  	ResourceManager.createFlyAnim(images[0][1],images[0][2],images[0][3]);

            	Fireball fb = new Fireball(anim, anim, anim, anim);
            	fb.shoot(player.getX(), player.getY(), direction);
               */
            if(shoot.isPressed()){	
            	if (shoot_count <= 9)
            	{
	...
	public void draw(Graphics2D g) {renderer.draw(g, map,screen.getWidth(), screen.getHeight());
    Player player = (Player)map.getPlayer();
